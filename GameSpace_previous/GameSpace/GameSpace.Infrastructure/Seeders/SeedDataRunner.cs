...
namespace GameSpace.Infrastructure.Seeders
{
    public class SeedDataRunner
    {
        ...
        private async Task SeedEVoucherTypesAsync()
        {
            ...
            {
                new EVoucherType { TypeID = 1, TypeName = "電子優惠券", Description = "電子優惠券類型", IsActive = true, CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now },
                new EVoucherType { TypeID = 2, TypeName = "折扣券", Description = "折扣優惠券", IsActive = true, CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now },
                new EVoucherType { TypeID = 3, TypeName = "滿額送", Description = "滿額贈送", IsActive = true, CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now },
                new EVoucherType { TypeID = 4, TypeName = "現金券", Description = "現金抵用券", IsActive = true, CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now },
                new EVoucherType { TypeID = 5, TypeName = "特價券", Description = "特價優惠券", IsActive = true, CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now },
                new EVoucherType { TypeID = 6, TypeName = "加值券", Description = "加值優惠券", IsActive = true, CreatedAt = DateTime.Now, UpdatedAt = DateTime.Now }
            };
